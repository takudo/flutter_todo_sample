...
// ignore: unused_element
  _LoginState call({GoogleSignInAccount account}) {
    return _LoginState(
      account: account,
    );
  }
...
class _$_LoginState extends _LoginState {
  _$_LoginState({this.account}) : super._();
  ...
  @override
  String toString() {
    return 'LoginState(account: $account)';
  }
...
abstract class _LoginState extends LoginState {
  ...
  factory _LoginState({GoogleSignInAccount account}) = _$_LoginState;
